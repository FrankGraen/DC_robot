...
程序位于 \path{daran/task2/pick_and_place.py}，采用示教点回放方式完成 A 点抓取和 B 点放置。示教文件 \path{ref_pose.json} 中记录了四个关键点：
...
夹爪控制未直接使用原始 \texttt{grasp()} 接口，而是根据实测关系调用底层 \path{set_angle_adaptive}：
\[
